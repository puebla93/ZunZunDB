...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { cd: @magazine.cd, issn: @magazine.issn, month: @magazine.month, number: @magazine.number, year: @magazine.year }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { cd: @magazine.cd, issn: @magazine.issn, month: @magazine.month, number: @magazine.number, year: @magazine.year }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
